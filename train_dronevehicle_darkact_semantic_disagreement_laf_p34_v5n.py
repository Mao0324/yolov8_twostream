#!/usr/bin/env python3
"""Train scale-n YOLOv5 DA-016 with DDP-safe monitor and queue integration."""
...
CHECKPOINT = str(
    repo_path("pre-pth/yolov5nu_twostream_darkact_da016_semantic_disagreement_laf_p34_scalen.pt")
)
DATA = str(repo_path("data/dronevehicle.yaml"))
PROJECT = str(repo_path("runs/DroneVehicle_OBB_FusionTransfer"))
EXPERIMENT_NAME = "YOLOv5nU_DA016_SemanticDisagreementLAF_P34_H2-4-8_R4-NoStaticMAA_v1"
