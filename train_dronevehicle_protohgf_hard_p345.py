#!/usr/bin/env python3
"""Train ProtoHGFNet PHG-001 (hard top-k fusion on P3/P4/P5)."""
...
CHECKPOINT = str(ROOT / "pre-pth/yolov8s-obb_twostream_protohgf_hard_p345.pt")
EXPERIMENT_NAME = "ProtoHGF_PHG001_HardK6K3_P345_v1"
...
results = monitor.run(
    ...
    workers=8,
    device=QUEUE.device,
    project=str(ROOT / "runs/DroneVehicle_OBB_ProtoHGFNet"),
