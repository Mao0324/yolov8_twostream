#!/usr/bin/env python3
"""Train P2D-005: dual prompts and GDER at P3/P4/P5."""

# 对应模型 YAML：yaml/yolov8s-P2Det-DualPrompt-GDER-P345-PostC2f-v5.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-DualPrompt-GDER-P345-PostC2f-v5.yaml"))
EXPERIMENT_NAME = "P2D-005_DualPrompt-GDER-P345_PostC2f_v5"
