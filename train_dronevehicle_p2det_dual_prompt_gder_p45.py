#!/usr/bin/env python3
"""Train P2D-004: dual prompts at P3/P4/P5 with GDER at P4/P5."""

# 对应模型 YAML：yaml/yolov8s-P2Det-DualPrompt-P345-GDER-P45-PostC2f-v4.yaml
...
from tools.training_monitor import MonitoredP2PromptOBBTrainer, create_monitor


CHECKPOINT = str(repo_path("pre-pth/yolov8s-obb.pt"))
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-DualPrompt-P345-GDER-P45-PostC2f-v4.yaml"))
EXPERIMENT_NAME = "P2D-004_DualPrompt-P345-GDER-P45_PostC2f_v4"
...
def main():
    ...
    return monitor.run(
        model.train,
        trainer=MonitoredP2PromptOBBTrainer,
