#!/usr/bin/env python3
"""Train P2D-009: RGB global prompt plus identity-preserving GDER."""

# 对应模型 YAML：yaml/yolov8s-P2Det-DualPrompt-RGBGlobal-IdentityGDER-P45-NoStaticMAA-v9.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-DualPrompt-RGBGlobal-IdentityGDER-P45-NoStaticMAA-v9.yaml"))
EXPERIMENT_NAME = "P2D-009_DualPrompt-RGBGlobal-IdentityGDER-P45-NoStaticMAA_v9"
