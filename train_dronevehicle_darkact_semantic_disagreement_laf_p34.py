"""Train DA-016 with the repository's unchanged DroneVehicle 100-epoch policy."""
...
CHECKPOINT = str(ROOT / "pre-pth/yolov8s-obb_twostream_darkact_da016_semantic_disagreement_laf_p34.pt")
EXPERIMENT_NAME = "DarkAct_DA016_SemanticDisagreementLAF_P34_H2-4-8_R4-NoStaticMAA_v1"
