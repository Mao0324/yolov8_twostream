#!/usr/bin/env python3
"""Train P2D-003: dual prompts at P3/P4 with GDER at P4."""

# 对应模型 YAML：yaml/yolov8s-P2Det-DualPrompt-GDER-P4-PostC2f-v3.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-DualPrompt-GDER-P4-PostC2f-v3.yaml"))
EXPERIMENT_NAME = "P2D-003_DualPrompt-GDER-P4_PostC2f_v3"
