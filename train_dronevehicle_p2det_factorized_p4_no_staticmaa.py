#!/usr/bin/env python3
"""Train P2D-010: V9 with factorized P4 channel/spatial expert gating."""

# 对应模型 YAML：yaml/yolov8s-P2Det-DualPrompt-RGBGlobal-IdentityGDER-FactorizedP4-NoStaticMAA-v10.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-DualPrompt-RGBGlobal-IdentityGDER-FactorizedP4-NoStaticMAA-v10.yaml"))
EXPERIMENT_NAME = "P2D-010_DualPrompt-RGBGlobal-IdentityGDER-FactorizedP4-NoStaticMAA_v10"
