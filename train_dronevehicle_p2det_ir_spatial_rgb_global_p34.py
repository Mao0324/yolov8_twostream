#!/usr/bin/env python3
"""Train P2D-007: IR spatial and RGB global prompts at P3/P4."""

# 对应模型 YAML：yaml/yolov8s-P2Det-IRSpatial-RGBGlobal-P34-PostC2f-v7.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-IRSpatial-RGBGlobal-P34-PostC2f-v7.yaml"))
EXPERIMENT_NAME = "P2D-007_IRSpatial-RGBGlobal-P34_PostC2f_v7"
