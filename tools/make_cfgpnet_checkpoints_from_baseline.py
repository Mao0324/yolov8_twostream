#!/usr/bin/env python3
"""Create CFGPNet checkpoints with the exact baseline initialization.
...
VARIANTS = (
    (
        "CF-001",
        ROOT / "yaml/cfgpnet_crosscea_asaf_p345.yaml",
        ROOT / "pre-pth/yolov8s-obb_twostream_cfgp_crosscea_asaf_p345.pt",
        (23, 24, 25),
    ),
    (
        "CF-002",
        ROOT / "yaml/cfgpnet_crosscea_asaf_p34.yaml",
        ROOT / "pre-pth/yolov8s-obb_twostream_cfgp_crosscea_asaf_p34.pt",
        (23, 24),
    ),
    (
        "CF-003",
        ROOT / "yaml/cfgpnet_crosscea_only_p345.yaml",
        ROOT / "pre-pth/yolov8s-obb_twostream_cfgp_crosscea_only_p345.pt",
        (23, 24, 25),
    ),
)
...
EXPECTED_VARIANT_LAYERS = {
    ...
    19: "C2f",
    21: "C2f_Faster",
    23: "CFGPCrossAttentionFusion",
    24: "CFGPCrossAttentionFusion",
    25: "CFGPCrossAttentionFusion",
    38: "OBB",
}
...
def _migrate(baseline_state, baseline_metadata, experiment_id, yaml_path, output, fusion_layers):
    ...
    for layer in fusion_layers:
        ...
        if type(module).__name__ != "CFGPCrossAttentionFusion":
            raise RuntimeError("layer {} is not CFGPCrossAttentionFusion".format(layer))
