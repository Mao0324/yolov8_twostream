#!/usr/bin/env python3
"""Train CFGPNet CF-001 (CrossCEA + ASAF on P3/P4/P5)."""
...
CHECKPOINT = str(ROOT / "pre-pth/yolov8s-obb_twostream_cfgp_crosscea_asaf_p345.pt")
EXPERIMENT_NAME = "CFGP_CF001_CrossCEA_ASAF_P345_v1"
...
results = monitor.run(
    ...
    workers=8,
    device=QUEUE.device,
    project=str(ROOT / "runs/DroneVehicle_OBB_CFGPNet"),
