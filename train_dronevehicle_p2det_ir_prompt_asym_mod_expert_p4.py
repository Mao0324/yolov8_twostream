#!/usr/bin/env python3
"""Train P2D-014: V13 P4 asymmetric modality expert only, without attention or gate."""

# 对应模型 YAML：yaml/yolov8s-P2Det-IRPrompt-AsymModExpert-P4-NoStaticMAA-PostC2f-v14.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-IRPrompt-AsymModExpert-P4-NoStaticMAA-PostC2f-v14.yaml"))
EXPERIMENT_NAME = "P2D-014_IRPrompt-AsymModExpert-P4-NoStaticMAA_PostC2f_v14"
