#!/usr/bin/env python3
"""Train ProtoHGFNet PHG-002 (hard top-k fusion on P3/P4)."""
...
CHECKPOINT = str(ROOT / "pre-pth/yolov8s-obb_twostream_protohgf_hard_p34.pt")
EXPERIMENT_NAME = "ProtoHGF_PHG002_HardK6K3_P34_v1"
