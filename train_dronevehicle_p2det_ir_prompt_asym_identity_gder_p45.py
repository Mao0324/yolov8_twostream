#!/usr/bin/env python3
"""Train P2D-012: IR-only Prompt with asymmetric identity GDER at P4/P5."""

# 对应模型 YAML：yaml/yolov8s-P2Det-IRPrompt-AsymIdentityGDER-P45-NoStaticMAA-PostC2f-v12.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-IRPrompt-AsymIdentityGDER-P45-NoStaticMAA-PostC2f-v12.yaml"))
EXPERIMENT_NAME = "P2D-012_IRPrompt-AsymIdentityGDER-P45-NoStaticMAA_PostC2f_v12"
