#!/usr/bin/env python3
"""Train the scale-s three-class FLIR DarkAct SemanticDisagreementLAF HBB model."""
...
EXPERIMENT_NAME = "FLIR_DarkAct_SemanticDisagreementLAF_P34_R4_NoStaticMAA_scales_3Class_HBB"
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--weights", type=Path, default=CHECKPOINT, help="migrated scale-s HBB checkpoint")
...
def main():
    """Launch a manual or Agent queue-managed, DDP-safe monitored FLIR HBB run."""
    ...
    if not queue_checkpoint.is_file():
        raise FileNotFoundError(
            ...
            "Run: python tools/make_twostream_hbb_weights_flir_scales.py"
        )
