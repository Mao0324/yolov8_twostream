#!/usr/bin/env python3
"""Train P2D-011: IR Prompt P3/P4 plus LAF, without StaticMAA or GDER."""

# 对应模型 YAML：yaml/yolov8s-P2Det-IRPrompt-P34-NoStaticMAA-NoGDER-PostC2f-v11.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-IRPrompt-P34-NoStaticMAA-NoGDER-PostC2f-v11.yaml"))
EXPERIMENT_NAME = "P2D-011_IRPrompt-P34-NoStaticMAA-NoGDER_PostC2f_v11"
