#!/usr/bin/env python3
"""Train P2D-001: IR prompt at P3/P4 after C2f."""

# 对应模型 YAML：yaml/yolov8s-P2Det-IRPrompt-P34-PostC2f-v1.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-IRPrompt-P34-PostC2f-v1.yaml"))
EXPERIMENT_NAME = "P2D-001_IRPrompt-P34_PostC2f_v1"
