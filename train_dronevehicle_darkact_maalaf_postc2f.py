# 训练（DroneVehicle DarkAct post-C2f StaticMAA2D + LAF feedback）
# 对应模型 YAML：yaml/yolov8s-DarkAct-MAA2D-LAFMerge-P345-R4-PostC2f-v1.yaml
import inspect
import os
...
# 直接从 Post-C2f 迁移 checkpoint 启动，确保双卡 DDP 加载权重。
CHECKPOINT = str(repo_path("pre-pth/yolov8s-obb_twostream_darkact_staticmaa_laffeedback_postc2f_p345_v1.pt"))
EXPERIMENT_NAME = "DarkAct_StaticMAA2DLAFMergeFeedback_P345_H2-4-8_PostC2f-MSK3-5-R4-PosBeta-DW3D1-2-2_v1"
