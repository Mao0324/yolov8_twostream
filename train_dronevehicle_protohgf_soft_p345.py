#!/usr/bin/env python3
"""Train ProtoHGFNet PHG-003 (soft top-k fusion on P3/P4/P5)."""
...
CHECKPOINT = str(ROOT / "pre-pth/yolov8s-obb_twostream_protohgf_soft_p345.pt")
EXPERIMENT_NAME = "ProtoHGF_PHG003_SoftK6K3_P345_v1"
