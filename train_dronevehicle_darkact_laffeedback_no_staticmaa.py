# 训练（DroneVehicle DarkAct LAFMergeFeedback2D，完全去除 StaticMAA2D）
# 对应模型 YAML：yaml/yolov8s-DarkAct-LAFMergeFeedback2D-P345-R4-NoStaticMAA-v1.yaml
import inspect
import os
...
# 直接从该架构的迁移 checkpoint 启动，确保双卡 DDP 加载权重。
CHECKPOINT = str(repo_path("pre-pth/yolov8s-obb_twostream_darkact_laffeedback2d_p345_r4_no_staticmaa_v1.pt"))
EXPERIMENT_NAME = "DarkAct_LAFMergeFeedback2D_P345_H2-4-8_R4-DW3D1-2-2_v1"
