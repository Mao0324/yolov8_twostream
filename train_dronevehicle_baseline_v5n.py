#!/usr/bin/env python3
"""Train the two-stream YOLOv5n-style OBB baseline with monitor support."""
...
CHECKPOINT = str(repo_path("pre-pth/yolov5nu_twostream_baseline_v5n_obb.pt"))
DATA = str(repo_path("data/dronevehicle.yaml"))
PROJECT = str(repo_path("runs_baseline_v5n"))
EXPERIMENT_NAME = "YOLOv5nU_TwoStream_OBB_Baseline_v1"
