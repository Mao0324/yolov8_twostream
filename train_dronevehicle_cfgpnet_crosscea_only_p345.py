#!/usr/bin/env python3
"""Train CFGPNet CF-003 (CrossCEA only on P3/P4/P5)."""
...
CHECKPOINT = str(ROOT / "pre-pth/yolov8s-obb_twostream_cfgp_crosscea_only_p345.pt")
EXPERIMENT_NAME = "CFGP_CF003_CrossCEAOnly_P345_v1"
