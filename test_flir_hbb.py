...
# python test_flir_hbb.py --weights "runs/FLIR_Align_HBB/train-labels=aligned-3class-v1/darkact/mainline/FLIR-001__semantic-disagreement-p34/seed=000/attempt=01/weights/best.pt"
