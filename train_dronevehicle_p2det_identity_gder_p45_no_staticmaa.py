#!/usr/bin/env python3
"""Train P2D-008: identity-preserving GDER at P4/P5 without StaticMAA."""

# 对应模型 YAML：yaml/yolov8s-P2Det-DualPrompt-IdentityGDER-P45-NoStaticMAA-v8.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-DualPrompt-IdentityGDER-P45-NoStaticMAA-v8.yaml"))
EXPERIMENT_NAME = "P2D-008_DualPrompt-IdentityGDER-P45-NoStaticMAA_v8"
