...
生成时间：2026-08-18T15:58:45+08:00
...
- 文件：[Manifest](manifests/CF-001.yaml) · [YAML](../../yaml/cfgpnet_crosscea_asaf_p345.yaml) · [旧 Train](../../train_dronevehicle_cfgpnet_crosscea_asaf_p345.py) · [迁移脚本](../../tools/make_cfgpnet_checkpoints_from_baseline.py)。
...
- 文件：[Manifest](manifests/CF-002.yaml) · [YAML](../../yaml/cfgpnet_crosscea_asaf_p34.yaml) · [旧 Train](../../train_dronevehicle_cfgpnet_crosscea_asaf_p34.py) · [迁移脚本](../../tools/make_cfgpnet_checkpoints_from_baseline.py)。
...
- 文件：[Manifest](manifests/CF-003.yaml) · [YAML](../../yaml/cfgpnet_crosscea_only_p345.yaml) · [旧 Train](../../train_dronevehicle_cfgpnet_crosscea_only_p345.py) · [迁移脚本](../../tools/make_cfgpnet_checkpoints_from_baseline.py)。
