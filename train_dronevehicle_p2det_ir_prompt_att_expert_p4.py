#!/usr/bin/env python3
"""Train P2D-015: V13 P4 prior-agnostic attention expert only, without modality or gate."""

# 对应模型 YAML：yaml/yolov8s-P2Det-IRPrompt-AttExpert-P4-NoStaticMAA-PostC2f-v15.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-IRPrompt-AttExpert-P4-NoStaticMAA-PostC2f-v15.yaml"))
EXPERIMENT_NAME = "P2D-015_IRPrompt-AttExpert-P4-NoStaticMAA_PostC2f_v15"
