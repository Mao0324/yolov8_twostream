#!/usr/bin/env python3
"""Train P2D-006: P2D-004 without StaticMAA at P3/P4/P5."""

# 对应模型 YAML：yaml/yolov8s-P2Det-DualPrompt-GDER-P45-NoStaticMAA-v6.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-DualPrompt-GDER-P45-NoStaticMAA-v6.yaml"))
EXPERIMENT_NAME = "P2D-006_DualPrompt-GDER-P45-NoStaticMAA_v6"
