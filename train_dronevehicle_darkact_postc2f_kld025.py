"""Train DA-004 with L_reg = 0.75 ProbIoU + 0.25 paper KLD."""
...
CHECKPOINT = str(ROOT / "pre-pth/yolov8s-obb_twostream_darkact_postc2f_kld025_v1.pt")
EXPERIMENT_NAME = "DarkAct_PostC2fStaticMAA_LAFFeedback_P345_KLDProbIoU025_v1"
