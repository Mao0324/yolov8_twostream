#!/usr/bin/env python3
"""Train P2D-002: dual RGB/IR prompts at P3/P4 after C2f."""

# 对应模型 YAML：yaml/yolov8s-P2Det-DualPrompt-P34-PostC2f-v2.yaml
...
MODEL_YAML = str(repo_path("yaml/yolov8s-P2Det-DualPrompt-P34-PostC2f-v2.yaml"))
EXPERIMENT_NAME = "P2D-002_DualPrompt-P34_PostC2f_v2"
